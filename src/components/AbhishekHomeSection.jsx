                ...
                <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
                    ...
                    >
                        <div className="relative">
                            ...
                            {/* Experience Card */}
                            <div
                                className="absolute -top-8 -left-8 bg-blue-600 text-white p-6 rounded-3xl shadow-xl hidden md:block animate-gpu-float"
                            >
                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        ...
                        >
                            <Link
                                href="/about"
                                aria-label="Learn More About Dr. Abhishek Saxena"
